...
def installation_process() -> None:
    ...
    try:
        ...
        messagebox.showerror(
            ...
            "Please make sure that your connection to the internet works and retry the installation."
        )
        sys.exit(0)
...
label = Label(
    ...
    f"This program will install the latest version of CNApy ({CNAPY_VERSION}) for you.\n"
